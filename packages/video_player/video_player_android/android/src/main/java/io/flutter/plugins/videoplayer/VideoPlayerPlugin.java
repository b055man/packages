...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
    ...
    @Override
    public void changeAudioTrack(@NonNull AudioTrackMessage arg) {
        VideoPlayer player = videoPlayers.get(arg.getTextureId());
        AudioTrack audioTrackFromMessage = new AudioTrack(arg.getGroupId().intValue(), arg.getTrackId().intValue());
        player.changeAudioTrack(audioTrackFromMessage);
    }
